...
import HautevilleHouse.MaterialsEngineeringFormingProcessesLemmaCanonicalLaneLean.AdmissibleClass
import HautevilleHouse.MaterialsEngineeringFormingProcessesLemmaCanonicalLaneLean.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "materials-engineering-forming-processes-lemma",
  theoremObject := "Manifold yield surface closure for von Mises isotropic hardening",
